...
router.get("/:movieId", function(req, res, next) {
  ...
  const moviePromise1 = axios.get(
    `${baseUrl}${movieId}?api_key=885dbfba88f11b7023082ad1956f5310&language=en-US`
  );

  const creditsPromise2 = axios.get(
    `${baseUrl}${movieId}/credits?api_key=885dbfba88f11b7023082ad1956f5310`
  );
